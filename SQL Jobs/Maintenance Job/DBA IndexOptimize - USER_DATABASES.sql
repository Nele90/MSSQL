...
/****** Object:  Job [DBA: IndexOptimize - USER_DATABASES]    Script Date: 2/2/2024 11:19:40 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 2/2/2024 11:19:40 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [IndexOptimize - USER_DATABASES]    Script Date: 2/2/2024 11:19:41 AM ******/
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'dailiy at 4am', 
		...
		@schedule_uid=N'84cb94b6-ede7-4b07-b1eb-8b1a46705c68'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
