...
/****** Object:  Job [DBA: DatabaseIntegrityCheck - SYSTEM_DATABASES]    Script Date: 13.05.2024 10:28:48 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [SQL DBA Maintenance]    Script Date: 13.05.2024 10:28:49 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [DatabaseIntegrityCheck - SYSTEM_DATABASES]    Script Date: 13.05.2024 10:28:49 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Every_Last_Sundat_5am', 
		@enabled=1, 
		@freq_type=32, 
		@freq_interval=1, 
		@freq_subday_type=1, 
		...
		@schedule_uid=N'60468cd0-c5bc-4268-ad27-98f4e71c685c'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
