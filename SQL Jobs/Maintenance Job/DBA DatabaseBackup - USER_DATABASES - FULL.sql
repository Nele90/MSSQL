...
/****** Object:  Job [DatabaseBackup - USER_DATABASES - FULL]    Script Date: 2/2/2024 11:24:35 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 2/2/2024 11:24:35 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [DatabaseBackup - USER_DATABASES - FULL]    Script Date: 2/2/2024 11:24:35 AM ******/
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Dailiy at 1am', 
		...
		@schedule_uid=N'625f8023-a1f4-4ba5-9cd1-5b82acaf63d2'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
