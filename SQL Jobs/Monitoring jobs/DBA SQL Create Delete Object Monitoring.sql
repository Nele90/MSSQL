...
/****** Object:  Job [DBA: SQL Create Delete Object Monitoring]    Script Date: 29.03.2024 09:50:03 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [SQL DBA Monitoring]    Script Date: 29.03.2024 09:50:03 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'DBA: SQL Create Delete Object Monitoring', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Insert Into monitoring table]    Script Date: 29.03.2024 09:50:04 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Insert Into monitoring table', 
		@step_id=1, 
...
WHERE name IN (''Object:Deleted'',''Object:Created'') and StartTime > DATEADD(HOUR, -1, GETDATE())
	and DatabaseID <> 2 and subclass_name = ''commit''  and ObjectName NOT LIKE ''_WA_Sys_%'' and ObjectName <> ''telemetry_xevents'' and ObjectName <> ''sqlservicestemp''
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Hourly', 
		...
		@schedule_uid=N'9b221a4c-4d0b-4dcb-89d9-74b1dc6b22dc'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
